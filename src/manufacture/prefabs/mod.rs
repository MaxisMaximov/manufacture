...
impl gmPrefab for prefab_GridWorldChunk{
    fn spawn(&self, IN_builder: gmObjBuilder) {
        IN_builder
            ...
            .addComp(comp_Sprite{ sizeX: CHUNK_X as usize, sizeY: CHUNK_Y as usize, sprite: vec![StyleSet{ ch: '0', fg: self.color, bg: Color::Black }; CHUNK_X as usize * CHUNK_Y as usize], zDepth: 0 });
    }
}